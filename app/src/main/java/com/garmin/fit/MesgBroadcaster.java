...
public class MesgBroadcaster implements MesgListener, MesgDefinitionListener {
   ...
   public MesgBroadcaster(Decode decode) {
      ...
      batteryMesgListeners = new ArrayList<BatteryMesgListener>();
   }
   ...
   public void addListener(BatteryMesgListener batteryMesgListener) {
      batteryMesgListeners.add(batteryMesgListener);
   }
      ...
      switch (mesg.getNum()) {
         ...
         case MesgNum.PAD:
          ...
          case MesgNum.BATTERY:
            final BatteryMesg batteryMesg = new BatteryMesg(mesg);
            for (final BatteryMesgListener mesgListener : batteryMesgListeners)
               mesgListener.onMesg(batteryMesg);
            break;
